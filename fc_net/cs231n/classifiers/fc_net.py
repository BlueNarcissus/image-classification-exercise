...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        """
        scores = None
        hidden_layer, _ = affine_forward(X, self.params['W1'], self.params['b1']) #(N,H)
        hidden_layer, _ = relu_forward(hidden_layer)
        scores, _ = affine_forward(hidden_layer, self.params['W2'], self.params['b2']) #(N,C)
        ############################################################################
        ...
        # backward pass
        dhidden, grads['W2'], grads['b2'] = affine_backward(dscores, (hidden_layer, self.params['W2'], self.params['b2']))
        grads['W2'] += self.reg*self.params['W2']
        
        dhidden  = relu_backward(dhidden, hidden_layer)
        dX, grads['W1'], grads['b1'] = affine_backward(dhidden, (X, self.params['W1'], self.params['b1']))
...
class FullyConnectedNet(object):
    ...
    def __init__(self, hidden_dims, input_dim=3*32*32, num_classes=10,
        ...
        Inputs:
        - hidden_dims: A list of integers giving the size of each hidden layer. [H1, H2]
        - input_dim: An integer giving the size of the input. D
        - num_classes: An integer giving the number of classes to classify. C
    ...
    def loss(self, X, y=None):
        ...
        # backward pass: affine_backward for the L-th layer
        dh = {}
        dh[L-1], grads['W%d'%L], grads['b%d'%L] = affine_backward(dscores, (hidden_layer[L-1], self.params['W%d'%L], self.params['b%d'%L]))
